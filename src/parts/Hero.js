...
import IconTreasure from 'assets/images/icons/ic-treasures.svg';
import IconTraveler from 'assets/images/icons/ic-travelers.svg';
            ...
            <div className="row align-items-center">
                <div className="col-auto pr-5" style={{width: 530}}>
                    ...
                    <p className="mb-4 font-weight-light text-gray-500 w-75" style={{lineHeight:"170%"}}>
                        We provide what you need to enjoy your holiday with family. This time to make another memorable moments.
                    </p>
                    ...
                    <div className="row" style={{marginTop:80}}>
                        ...
                        <div className="col-auto">
                            <img width="36" height="36" src={IconCities} alt={`${props.data.travelers} Cities`}/>
                            <h6 className="mt-3">
